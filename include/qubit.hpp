...
///@tparam FloatingNumberType The type of the floating-point number used to represent the amplitudes of the qubit state.
    ...
    public:
        ...
        public:
            ...
            State(std::shared_ptr<ProbabilityEngine<FloatingNumberType>> probabilityEngine,
                  const std::complex<FloatingNumberType> &alpha, const std::complex<FloatingNumberType> &beta);
